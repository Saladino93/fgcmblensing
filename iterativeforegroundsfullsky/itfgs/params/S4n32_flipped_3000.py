...
def get_info(caso: str) -> tuple:
    ...
    if caso == casorand:
        ...
        suffixCMB = suffix+'FlippedBornRand5120_3000'
        suffixCMBPhas = suffix
        suffixLensing = suffix+'FlippedBornRand5120_3000'

        SimsShegalDict = {}
        SimsShegalDict['kappa'] = lambda idx: opj(baseSehgal, 'map0_kappa_ecp262_dmn2_lmax8000_first_randomized_alm.fits')

    elif caso == casogauss:
        suffixCMB = suffix+'FlippedBornGauss5120_3000'
        suffixCMBPhas = suffix
        suffixLensing = suffix+'FlippedBornGauss5120_3000'

        SimsShegalDict = {}
        SimsShegalDict['kappa'] = lambda idx: opj(baseSehgal, f'bornGaussian/born_kappa_gauss_alm_{idx}.fits')

    elif caso == casostd:
        suffixCMB = suffix+'FlippedBorn5120_3000'
        suffixCMBPhas = suffix
        suffixLensing = suffix+'FlippedBorn5120_3000'
        ...
        suffixCMB = suffix+'FlippedPostBorn5120_3000'
        suffixCMBPhas = suffix
        suffixLensing = suffix+'FlippedPostBorn5120_3000'
        ...
        suffixCMB = suffix+'FlippedPostBornRand5120_3000'
        suffixCMBPhas = suffix
        suffixLensing = suffix+'FlippedPostBornRand5120_3000'
        ...
        suffixCMB = suffix+'FlippedPostBornGauss5120_3000'
        suffixCMBPhas = suffix
        suffixLensing = suffix+'FlippedPostBornGauss5120_3000'
...
def get_all(case: str):
    ...
    lmax_ivf, mmax_ivf, beam, nlev_t, nlev_p = (3000, 3000, 1., 1., 1. * np.sqrt(2.))
