...
suffix = 'S4Giulio_lmax_5000' # descriptor to distinguish this parfile from others...
...
def get_info(caso: str) -> tuple:
    ...
    if caso == casorand:
        ...
        suffixCMB = suffix+'BornRand5120_lmax_5000'
        suffixCMBPhas = suffix
        suffixLensing = suffix+'BornRand5120_lmax_5000'
...
def get_all(case: str):
    ...
    lmax_ivf, mmax_ivf, beam, nlev_t, nlev_p = (5000, 5000, 1., 1., 1. * np.sqrt(2.))
    ...
    geominfo_defl = ('thingauss', {'lmax': 5200 + 300, 'smax': 2})
    ...
    transf_dat =  gauss_beam(beam / 180 / 60 * np.pi, lmax=5096) # (taking here full sims cmb's which are given to 4096)
