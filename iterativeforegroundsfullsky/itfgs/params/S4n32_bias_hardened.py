...
def get_all(case: str):
    ...
    if "websky" in case:
        ...
        cls_unl_wcurl["oo"] = cls_rot*factor
    ...
    libPHASCMB = phas.lib_phas(os.path.join(lib_dir_CMB, 'phas'), 5, lmax_cmb + dlmax)
    ...
    def get_itlib(k:str, simidx:int, version:str, cg_tol:float, epsilon=1e-5):
        ...
        keyP, keyOther = "p", "s"
        iterator = iterator_cstmf_wcurl(libdir_iterator, keyP, [(lmax_qlm, mmax_qlm), (lmax_qlm, mmax_qlm)], datmaps,
                [plm0, olm0], [mf0_p, mf0_o], [Rpp_unl, Roo_unl], [cpp, coo], (keyP, keyOther), cls_unl, filtr, k_geom, chain_descrs(lmax_unl, cg_tol), stepper,
