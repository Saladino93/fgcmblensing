...
baseSehgal = opj(os.environ['SCRATCH'], 'SKYSIMS/AGORASIMS/')
#baseWebsky = opj(os.environ['SCRATCH'], 'SKYSIMS/WEBSKYSIMS/')
#baseSehgal = opj(os.environ['SCRATCH'], 'SehgalSims')

suffix = 'S4AGORA' # descriptor to distinguish this parfile from others...
...
def get_info(caso: str) -> tuple:
    ...
    if caso == casorand:
        ...
        SimsShegalDict = {}
        SimsShegalDict['kappa'] = lambda idx: opj(baseSehgal, 'cmbkappa', 'agora_born_cmbkappa_highzadded_lowLcorrected_randomized_alm.fits')
        ...
        SimsShegalDict = {}
        SimsShegalDict['kappa'] = lambda idx: opj(baseSehgal, 'gaussiancmbkappa', f'agora_born_cmbkappa_highzadded_lowLcorrected/agora_born_cmbkappa_highzadded_lowLcorrected_gauss_alm_{idx}.fits')
        ...
        SimsShegalDict = {}
        SimsShegalDict['kappa'] = lambda idx: opj(baseSehgal, 'cmbkappa', 'agora_born_cmbkappa_highzadded_lowLcorrected.fits')
        ...
        SimsShegalDict = {}
        SimsShegalDict['kappa'] = lambda idx: opj(baseSehgal, 'cmbkappa', 'agora_raytrace16384_cmbkappa_highzadded_lowLcorrected_alm.fits')
        ...
        SimsShegalDict = {}
        SimsShegalDict['kappa'] = lambda idx: opj(baseSehgal, 'cmbkappa', 'agora_raytrace16384_cmbkappa_highzadded_lowLcorrected_randomized_alm.fits')
        ...
        SimsShegalDict = {}
        SimsShegalDict['kappa'] = lambda idx: opj(baseSehgal, 'gaussiancmbkappa', f'agora_raytrace16384_cmbkappa_highzadded_lowLcorrected/agora_raytrace16384_cmbkappa_highzadded_lowLcorrected_gauss_alm_{idx}.fits')
...
def get_all(case: str):
    ...
    cls_path = opj(os.environ['HOME'], 'n32clean', 'data')
