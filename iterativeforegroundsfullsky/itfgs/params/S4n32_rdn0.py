...
def get_all(case: str, case_specific: str, sim_index: int):
    ...
    if case_specific == "":
        TEMP_RDN0 = "/users/odarwish/scratch/n32OFFICIAL/S4GiulioRDN05120/"
    elif case_specific == "rand":
        TEMP_RDN0 = "/users/odarwish/scratch/n32OFFICIAL/S4GiulioRandRDN05120/"
    elif case_specific == "gauss":
        TEMP_RDN0 = "/users/odarwish/scratch/n32OFFICIAL/S4GiulioGaussRDN05120/"
    ...
    sim_set_indices = np.arange(200, 302)
    ...
    def get_itlib(k:str, simidx:int, version:str, cg_tol:float, epsilon=1e-5):
        ...
        if not os.path.exists(path_plm0):
            ...
            casenames = ["sim", "sim_ds", "sim_ss"]

            for i, p_temp in enumerate([plm0, plm0_ds, plm0_ss]):
