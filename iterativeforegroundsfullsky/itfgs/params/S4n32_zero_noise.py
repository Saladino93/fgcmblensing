...
def get_info(caso: str) -> tuple:
    ...
    if caso == casorand:
        ...
        suffixLensing = suffix+'BornRand5120ZeroNoise_3000'
        ...
        suffixCMBPhas = suffix
        suffixLensing = suffix+'BornGauss5120ZeroNoise_3000'
        ...
        suffixCMBPhas = suffix
        suffixLensing = suffix+'Born5120ZeroNoise_3000'
...
def get_all(case: str):
    ...
    print("Note, different noise index!!", fixed_noise_index, "Zero noise", zero_noise)
    lmax_cmb = 4096
    dlmax = 1024
