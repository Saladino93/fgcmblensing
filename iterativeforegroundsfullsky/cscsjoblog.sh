...
#srun python ./itfgs/params/S4n32.py -k ptt -imin 0 -imax 63 -itmax 7 -tol 8 -case "postlog" 
#srun python ./itfgs/params/S4n32.py -k ptt -imin 0 -imax 63 -itmax 7 -tol 8 -case "postlogrand"
#srun python ./itfgs/params/S4n32.py -k ptt -imin 0 -imax 63 -itmax 7 -tol 8 -case "postborngauss"
srun python ./itfgs/scripts/analyzeresults.py -k "ptt" -imin 0 -imax 63 -itmax 7 -v "" -s "postlog"



#srun python ./itfgs/params/S4n32lnpri.py -k ptt -imin 0 -imax 7 -itmax 8 -tol 7 -case "logfactorskew" -v logpriornew

#srun python ./itfgs/params/S4n32lnpri.py -k ptt -imin 0 -imax 15 -itmax 12 -tol 7 -case "logfactorskew" -v logprior1901
#srun python ./itfgs/params/S4n32.py -k ptt -imin 0 -imax 15 -itmax 12 -tol 7 -case "logfactorskew" -v gaussprior1901

#srun python ./itfgs/params/S4n32.py -k ptt -imin 0 -imax 7 -itmax 7 -tol 7 -case "logfactorskew" 
#srun python ./itfgs/params/S4n32.py -k ptt -imin 0 -imax 7 -itmax 7 -tol 7 -case "randlogfactorskew"
#srun python ./itfgs/params/S4n32lnpri.py -k ptt -imin 0 -imax 7 -itmax 8 -tol 7 -case "logfactorskew" -v logpriornew
#srun python ./itfgs/params/S4n32lnpri.py -k ptt -imin 0 -imax 7 -itmax 8 -tol 7 -case "randlogfactorskew" -v logpriornew
...
#srun python ./itfgs/params/S4n32lnpri.py -k ptt -imin 0 -imax 15 -itmax 8 -tol 7 -case "gauss" -v logpriornew
