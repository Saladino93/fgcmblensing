...
TEMP =  os.path.join(os.environ['PLENS'], 'temp', 'idealized_example_original_gradweights_transf_one_no_te_ivf')
...
weights_file = 'FFP10_wdipole_lensedCls.dat'
weights_file = 'FFP10_wdipole_gradlensedCls.dat'
cl_weight = utils.camb_clfile(os.path.join(cls_path, weights_file))
cl_weight['bb'] *= 0.
